...
foreach ($arreglo as $row) {
    ...
    $Status=""; //
      ...
      echo("<td><a href='PrincipalRecepcionista.php?action=agenda_cita&id=" . $row['idPacientes'] . "&nombre=" . $row['Pac_nombre'] . "&apellido=" . $row['Pac_apellido'] . "&correo=" . $row['Pac_correo'] . "&telefono=" . $row['Pac_telefono'] . "&sexo=" . $row['Pac_sexo'] . "'>Agendar</a></td>
      </tr>");
